...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div>
                <a href="categoryAdd.php" class="text-capitalize add-item-admin__btn">
                    ...
                    <div class="table-responsive" style="min-height: 500px;">
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                $category = $category->getcategory_admin();
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td class="options">
                                                <a href="categoryEdit.php?MaDanhMucCon=<?php echo $result['MaDanhMucCon'] ?>">
